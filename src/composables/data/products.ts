...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Forro para cuadernos college en variedades de colores (amarillo, azul, blanco, café, celeste, morado, naranja, rojo, verde claro), pack de 10 unidades por color.',
    price: 250,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  },
  {
    ...
    description: 'Lápices grafito jumbo Arte Top.',
    price: 400,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  },
  {
    ...
    description: 'Lápices grafito N°2 HB, uso escolar estándar.',
    price: 150,
    category: 'utiles',
    inBanner: false,
    inStock: true,
