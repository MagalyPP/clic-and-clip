...
export const products: Product[] = [
  ...
  {
    id: 121,
    title: 'Block Matemática 7mm Anillado Carta 80 Hojas',
    description: 'Block de matemática 7mm anillado formato carta con 80 hojas marca Nuovo.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 122,
    title: 'Block Medio N°99 1/4',
    description: 'Block medio N°99 1/4 con 20 hojas Proarte para dibujo.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 123,
    title: 'Block N°99 1/8 10 Hojas',
    description: 'Block N°99 1/8 con 10 hojas marca Ross para actividades escolares.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 124,
    title: 'Caja Minas 0.7mm HB',
    description: 'Caja de minas 0.7mm HB con 24 unidades Fultons para portaminas.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 125,
    title: 'Carpeta Oficio con Acco Clip Plástico',
    description: 'Carpeta oficio con acco clip plástico resistente, disponible en colores variados (azul, blanco, celeste, rojo, rosado, verde claro).',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
    images: [
      ...
      getImagePath('CARPETA OFICIO CON ACCO CLIP PLASTICO CELESTE 1 UNIDAD JRF.gif'),
      getImagePath('CARPETA OFICIO CON ACCO CLIP PLASTICO ROJO JRF.gif'),
      getImagePath('CARPETA OFICIO CON ACCO CLIP PLASTICO ROSADO JRF.jpg'),
      getImagePath('CARPETA OFICIO CON ACCO CLIP PLASTICO VERDE CLARO 1 UNIDAD JRF.jpg'),
    ],
  },
  {
    id: 126,
    title: 'Cinta de Enmascarar 18mm',
    description: 'Cinta de enmascarar 18mm x 40mts, 8 unidades marca Lavoro para pintura y máscaras.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 127,
    title: 'Cinta de Enmascarar 36mm',
  ...
  {
    id: 128,
    title: 'Cuchillo Cartonero Chico',
    description: 'Cuchillo cartonero chico color naranja marca Fultons, herramienta útil para manualidades.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 129,
    title: 'Cuadernos Universitarios Kuromi',
    description: 'Cuadernos universitarios 7mm con diseños Kuromi 100 hojas, variedad de modelos.',
    price: 0,
    category: 'utiles',
    inBanner: true,
    inStock: true,
    images: [
      getImagePath('kuromi u10.jpg'),
      getImagePath('kuromi u2.jpg'),
      getImagePath('kuromi u3.jpg'),
      getImagePath('kuromi u4.jpg'),
      getImagePath('kuromi u5.jpg'),
      getImagePath('kuromi u6.jpg'),
      getImagePath('kuromi u7.jpg'),
      getImagePath('kuromi u8.jpg'),
      getImagePath('kuromi u9.jpg'),
    ],
  },
  {
    id: 130,
    title: 'Lápices Pastel Grasos 12 Colores',
    description: 'Set de lápices pastel grasos con 12 colores marca Art & Craft para dibujo artístico.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 133,
    title: 'Plumón Pizarra Rojo',
    description: 'Plumón para pizarra color rojo marca Fultons, 12 unidades.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
    images: [getImagePath('PLUMON PIZARRA ROJO 12 UNIDADES FULTONS.jpg')],
  },
  {
    id: 134,
    title: 'Pompón Mix Rojo',
    description: 'Pompones mix color rojo marca Vieri para manualidades y decoración.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 135,
    title: 'Push Pin Colores Surtidos',
    description: 'Push pins (alfileres de precisión) de colores surtidos, aproximado 40 unidades marca Isofit.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 138,
    title: 'Témpera Sólida 6 Colores',
    description: 'Témpera sólida con 6 colores de 10grs cada una marca Art & Craft.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 139,
    title: 'Vaso Plástico Empavonado 250ml',
    description: 'Vasos plásticos empavonados de 250ml, ideales para actividades escolares y manualidades.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 140,
    title: 'Guantes de Examen Vinilo con Polvo Talla S',
    description: 'Guantes de examen de vinilo con polvo talla S marca Adicare.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 141,
    title: 'Pizarra Magnética 28x21.7 cm',
    description: 'Pizarra magnética de 28x21.7 cm marca Proarte, perfecta para aulas y espacios de trabajo.',
    price: 0,
    category: 'utiles',
    inBanner: false,
    inStock: true,
